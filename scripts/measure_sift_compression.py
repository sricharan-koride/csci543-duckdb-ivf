...
INDEX_NAME = "sift_idx" # This is the name you used in 'create_ivf_index'
...
def main():
    ...
    # 1. Calculate Raw Vector Size (The Baseline)
    # SIFT has 1M vectors of 128 dimensions (floats)
    ...
    # 2. Calculate PQ Index Size (The Compressed Data)
    ...
    try:
        ...
        # Note: This is purely the vector data size. 
        # In a real disk footprint, there is overhead for row IDs, metadata, etc.
        # But this compares "Vector Payload" vs "Compressed Payload".
